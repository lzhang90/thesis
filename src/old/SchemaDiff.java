...
public class SchemaDiff {
    ...
    public void genConditions(){ //the condition is in the format "has(agent, predicate, object)"
    ...
    public void printPredicatesAndObjs(){
        for(int i=0;i<this.predicateAndObjsA.size();i++)
    ...
    public void readPredicatesAndObj(File file){
        try {
            String instance;
            String predicate;
            String thing;
    ...
    public void readInstancesFromFile(File file){
        try {
